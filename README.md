...
2. Number of paths
    ...
    - [problem](https://practice.geeksforgeeks.org/problems/number-of-paths/1)
...
14. Smallest containing window
    ...
    - [`T: O(n), S: O(n)`](../main/a112.cpp)

15. Majority Element
    - Arrays, Hashing, Searching
...
7. K-th Element of two Sorted Arrays
    ...
    - [`T: O(min(log(m),log(n))), S: O(1)`](../main/a169.cpp)
...
3. Rat in a Maze Problem - I
    - Backtracking, Algorithms, Matrix
    - [problem](https://practice.geeksforgeeks.org/problems/rat-in-a-maze-problem/1)
    - [`T: O(4^(n*n)), S: O(n^2)`](../main/a173.cpp)

4. Word Boggle
    - Backtracking, Graph, Algorithms
    - [problem](https://practice.geeksforgeeks.org/problems/word-boggle4143/1)
